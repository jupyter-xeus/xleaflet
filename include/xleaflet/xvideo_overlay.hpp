...
namespace xlf
{
    ...
    template <class D>
    inline void xvideo_overlay<D>::serialize_state(xeus::xjson& state, xeus::buffer_sequence& buffers) const
    {
    ...
    template <class D>
    inline void xvideo_overlay<D>::apply_patch(const xeus::xjson& patch, const xeus::buffer_sequence& buffers)
    {
